...
public class EdurekaPage extends BasePage{
	...
	public void setAtualizarDados() throws InterruptedException {
		...
		//Sigo uma cadeira de comandos Para preencher todas as op��es, deixando apenas "enviar arquivo de Fora"
		...
		//muda de pagina para para avan�ar evitando o bot�o 
		...
		//Ao voltar no "my Profile" clica em editar para atualizar as informa��es pessoais
